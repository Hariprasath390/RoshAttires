...
export default function Header() {
  ...
  return (
    <div className="">
      <div className="w-full bg-[#9c5642] h-7 sticky top-0 flex items-center justify-center z-50">
        <h4 className="  text-center text-white font-serif ">
          Get Cute TOPS at our INSTA Store also{" "}
        ...
        >
          ...
          <div className="flex lg:hidden">
            <button
              ...
              onMouseOver={() => setMobileMenuOpen(true)}
            >
          ...
          <Popover.Group className="hidden lg:flex lg:gap-x-12">
            <Popover className="relative">
              <Popover.Button className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-black/60">
                Tops
                <ChevronDownIcon
                ...
                <Popover.Panel className="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5">
                    ...
                    {products.map((item) => (
                      ...
                      >
                        ...
                        <div className="flex-auto">
                          <a
                            href={item.href}
                            className="block font-semibold text-black/60"
                          >
                            {item.name}
                  ...
                  <div className="grid grid-cols-2 divide-x divide-gray-900/5 bg-gray-50">
                    {callsToAction.map((item) => (
                      ...
                      >
                        <item.icon
                          className="h-5 w-5 flex-none text-black/60"
                          aria-hidden="true"
                        />
                        {item.name}
                      </a>
            ...
            {/* <Link legacyBehavior href="/components/productItems">
            {" "}
            ...
            <Link
              legacyBehavior
              href="/components/productItems"
              as="productItems"
            >
              <h3 className="text-sm font-semibold leading-6 text-black/60">
                Topss
              </h3>
            </Link>
            ...
            <a
              href="#"
              className="text-sm font-semibold leading-6 text-black/60"
            >
              Denim
            </a>
            <a
      ...
      <section class="flex flex-col lg:justify-end font-poppins bottom-0 absolute   w-full">
        <div class="relative py-10 bg-center bg-no-repeat bg-cover">
          <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-amber-950 via-[#9c5642] to-[#9c5642]  "></div>
          <div class="relative z-10 justify-center flex-1 max-w-6xl px-4 py-4 mx-auto lg:py-0">
            <div class="flex flex-wrap pb-10 -mx-3">
              ...
              <div class="w-full px-4 md:w-1/4 lg:w-2/12 mb-11 lg:mb-0">
                ...
                <ul>
                  ...
                  <li class="mb-4">
                    <a
                      href="#"
                      class="inline-block text-base font-normal text-gray-400 dark:text-gray-400"
                    >
                      Features
                    </a>
                  </li>
              ...
              <div class="w-full px-4 mb-11 lg:mb-0 md:w-1/4 lg:w-2/12">
                <h2 class="pb-2 text-lg font-bold text-gray-300">Features </h2>
                <div class="w-16 mb-4 border-b-2 border-gray-300 "></div>
                <ul>
                  <li class="mb-4">
                    <a
